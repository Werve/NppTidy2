...
@set TMPPRJ=Tidy2
@echo Build %TMPPRJ% project, in 32-bits
...
@set TMPPRE=F:\Projects\install\msvc%TY2_VC_VERS%%TY2_VC_POINT%-%TY2_RT_BITS%\tidy-5.6.0-vc%TY2_VC_VERS%-%TY2_RT_LINK%-%TY2_RT_BITS%b
@if NOT EXIST %TMPPRE%\nul goto NOPRE
...
@set TMPOPTS=%TMPOPTS% -DUSE_STATIC_RUNTIME:BOOL=YES
